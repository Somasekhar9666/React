...
const useOnlineStatus=()=>{
    ...
    useEffect(()=>{
        ...
        window.addEventListener("ofline", ()=>{setInternetStatus(false)});

    },[])

    //boolean value
    return internetStatus                  //you can use this hook in body.js at render function , based on the conditional renduring : "if (onlineStatus===false) return <h1>Plase Check internet Connection</h1>"
}
